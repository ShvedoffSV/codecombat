...
#    apcsp: "AP CS Principles"
    parent: "Батьки"
#    esports: "Esports"
    browser_recommendation: "Щоб найкраще все працювало, рекомендумо використовувати останню версію Chrome. Завантажте цей браузер тут!"
...
#    web_development_title: "__level__ | Web Development"
    ...
    anon_signup_title_2: "Версію для класу!"
...
#    simulate_all: "Simulate All"
  ...
  share_progress_modal:
    ...
    form_blurb: "Введіть їхні електронні адреси, і ми покажемо їм!"
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    dont_use_our_email_silly: "Не пишіть нашу електронну адресу тут! Введіть електронну адресу Ваших батьків."
    ...
    eu_confirmation_individual: "Якщо Ви не бажаєте зберігати свої дані на серверах США, то Ви завжди можете грати анонімно без збереження свого коду."
...
#    combo_challenge_goal: "Challenge Level Goal"
    ...
    check_dev_console: "Ви також можете відкрити консоль розробника аби перевірити, що там відбувається."
    ...
    tip_theory_practice: "Теоретично, між теорією і практикою немає ніякої різниці. А на практиці - є.  Йоґі Берра"
    ...
    project_complete: "Проєкт Завершено!"
    share_this_project: "Поділіться цим проєктом з друзями або родиною:"
    ready_to_share: "Готові опублікувати свій проєкт?"
    click_publish: "Натисніть \"Publish\", щоб проєкт з'явився в галереї класу, а потім перевірьте, що створили Ваші однокласники! Ви можете повернутися і продовжити працювати над цим проєктом. Будь-які подальші зміни будуть автоматично збережені та буде надано спільний доступ Вашим однокласникам."
    already_published_prefix: "Ваші зміни були опубліковані в галереї класу."
    already_published_suffix: "Продовжуйте експериментувати і робити цей проєкт ще кращим або подивіться, що побудували решта класа, ваші однокласники! Ваші зміни буде автоматично збережено та надіслано вашим однокласникам."
